...
export default function UserLists() {
  ...
  const datas = [
    {
      id: 0,
      email: "dummty@gmail.com",
      name: "Peter Dumbari",
      phoneNumber: "+38373938333",
      gender: "male",
    },
    {
      id: 1,
    ...
    <body style={{ backgroundColor: "#f1f1f2", height: "100vh" }}>
      ...
      <div className="container-fluid userlistbody" style={{ height: "auto" }}>
            ...
            <CDBContainer>
              <CDBInput
                ...
                icon={
                  <i
                    style={{ color: "gray" }}
                    className="fa fa-search text-transparent"></i>
                }
                background=" #028B2E0D"
        ...
        <div className="row mb-5">
          <div
            className="col- 11 col-md-8 col-lg-9 table-responsive"
              ...
              <tbody>
                {items.length > 0
                                ...
                                <CDBBox>
                                  <CDBDropDown className="ml-auto">
                                    ...
                                    <CDBDropDownMenu className="hi">
                                      <CDBDropDownItem>
                                        <Link
                                          to={`/userprofile/${users.name}/${users.gender}/${users.email}/${users.phoneNumber}`}
                  ...
                  : currentPosts.map((users) => (
                      <tr className="userlists-table-row" key={users.id}>
                        <td>
                          <span className="d-inline">
                            <img
                              src="https://th.bing.com/th/id/R.d268b238932809e18b85a7820184220f?rik=ahExR0U%2fu2zHyQ&riu=http%3a%2f%2ficon-library.com%2fimages%2fno-profile-picture-icon%2fno-profile-picture-icon-2.jpg&ehk=4X8pLfMkepeJcdTMZ8L033nQ2hfH0gJN3qGTpg62g00%3d&risl=&pid=ImgRaw&r=0"
          ...
          <div
            className="col-12 col-md-4 col-lg-3 mt-5"
            style={{
            ...
            <form action="">
              <div>
                ...
                <div
                  className="d-inline-flex p-2 mt-5"
                  style={{ width: "100%" }}>
                  <button
                    type="button"
